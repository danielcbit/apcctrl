...
double BrazilModelBackUPS800::getBattery12V07ASerie(){
	return 1;
}
double BrazilModelBackUPS800::getBattery12V07AParallel(){
	return 1;
}
double BrazilModelBackUPS800::getInverterEfficiency(){
	return 1.0;
}
